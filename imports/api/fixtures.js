  ...
  if (!demoListings.count()) {
    const data = [
      ...
      },
      {
        ...
        imgURL: '/ufs/photoStore/RKjMkSciyjiyTfay6/mqdefault_6s.webp',
        isNeed: true,
        createdAt: new Date('2022, 9, 30'),
        createdBy: demoUserId,
      },
